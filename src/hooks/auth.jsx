import { createContext, useContext, useEffect, useState } from "react"; // Importando Hooks do react, context, state, effect.

import { api } from "../services/api"; //  Importando API para utilizar na função de SignIn
